...
if (isset($_POST['add'])) {
    ...
    if (checkForErrors($_POST['name'], $_POST['price'], $_POST['hours'], $_POST['description'], $_FILES['img'])) {
        ...
        $offlineCourseQuery = "INSERT INTO `offcou` (`OffId`, `courseName`, `coursePrice`, `courseNumOfHours`, `OffDis`, `OffImage`, `AdminId`, `cat_id`) VALUES (NULL, '$name', '$price', '$hours', '$description', '$imgName', '1', '$catId');";
...
<html lang="en">
    ...
    <body>
        <div class="course">
            <div class="container">
                <form method="post" action="addOfflineCourse.php" enctype="multipart/form-data">
                    <h2>Add Offline Courses</h2>
                    <label>Name :</label><br>
