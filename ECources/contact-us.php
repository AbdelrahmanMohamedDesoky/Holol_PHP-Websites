...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="css/contact-us.css"> <!-- CSS File -->
        ...
        <section id="contact-us-content">
            <div class="container">
                <div class="contact-us-map col-xs-12">
                    <iframe class="col-xs-12" src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d13803.90341849937!2d31.2683238!3d30.1235044!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sar!2seg!4v1469401096735" width="1170" height="400" frameborder="0" style="border:0" allowfullscreen></iframe>
                </div>
                <div class="contact-us-forms col-xs-12">
                    ...
                    <div class="contact-form col-xs-12 col-lg-8">
                        <form class="col-lg-12" action = "contact-us.php" method = "POST">
                            <input type="text" placeholder="Name" name="name" class="col-md-5" required>
                            <input type="text" placeholder="Email" name="email" class="col-md-5 " required>
                            <input type="text" placeholder="Subject" name="subject" class="col-md-5 " required>
                            <textarea name="message" placeholder="Message" rows="5" class="col-xs-11" required></textarea>
                            <button class="btn col-xs-4" name = "submit">Send</button>
                        </form>
                        <?php
                        if (isset($emailSentMessage)) {
                            echo "<strong>$emailSentMessage</strong>";
