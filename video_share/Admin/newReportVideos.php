...
?>
        ...
        <!-- END HEADER SECTION -->
           ...
           <div id='left' >
                <div class='media user-media well-small'>
                    ...
                    <li class="active"><a href='newReportVideos.php'><i class='icon-columns'></i> today reported video </a></li>
                ...
                <div class='col-lg-12'>
                    <div class='panel panel-default'>
                        <div class='panel-heading'>
                            Today Reported video
                        </div>
                        <div class='panel-body'>
                            <div class='table-responsive'>
							<form action="newReportVideos.php"  method="post" >
   ...
   */    
										 ...
										 $result= $admin->showNewVideosReports();
										  ...
										  while($row = $result->fetch_assoc()) {
                                            ...
                                            <td><a href='../viewVideo.php?videoLink=".$row["videoLink"]."'>show video<a></td>
								...
								<input type="submit" class="'btn btn-danger" name="deleteVideo" value="delete Video"> </div>
                            </div>
							</form>
                            </div>
