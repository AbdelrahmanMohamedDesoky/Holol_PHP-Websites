...
else notify ("NOTICE:","Select video to delete");			
		   }
...
?>
        ...
        <!-- END HEADER SECTION -->
           ...
           <div id='left' >
                <div class='media user-media well-small'>
                    ...
                    <li class="active"><a href='videos.php'><i class='icon-table'></i>  videos </a></li>
    ...
    <!--END MENU SECTION -->
                        ...
                        <div class='panel-body'>
							...
							<form action="videos.php"  method="post" >
                                <table class='table table-striped table-bordered table-hover' id='dataTables-example'>
									...
									SELECT `videoId`, ` videoTitle`, `videoCategory`, `videoLink`, `videoKeywords`
									, `likes`, `views`, `videoDate`, `uploaderId`
									-->
                                        <tr>
										    <th> </th>
                                            <th>video Title</th>
      ...
      <!--**************==================== echo here ========================= ********--->
                                       ...
                                       <?php
   /*  
   SELECT  ` videoTitle`, `videoCategory`, `videoDate`,  `views`, `uploaderId` FROM `videos` 
   */
                                          
										 $result= $admin->showVideos();
										 
										  while($row = $result->fetch_assoc()) {
                                            echo "
											<tr>
											<td><input type='radio' name='videoId' value='".$row["videoId"]."'>
    ...
    <!--**************==================== end ========================= ********--->
							...
							<div style="text-align:center;"><input type="submit" class="'btn btn-danger" name="deleteVideo" value="delete"> </div>
                            </form>
							</div>
