        ...
        <!-- END HEADER SECTION -->
         ...
         <div id='left' >
                <div class='media user-media well-small'>
                    ...
                    <li class="active"><a href='deleteCategory.php'><i class='icon-film'></i> delete category </a></li>
...
<script>
        ...
        <div id='content'>
          <div id="collapseOne" class="accordion-body collapse in body" style="margin-top:200px;">
                                   <form  action="deleteCategory.php" method="post"class="form-horizontal" id="popup-validation">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-7">
                                                 <select name="categoryId" id="categoryId" class="validate[required] form-control">
							<option value=''>categoryName</option>
								...
								?>
										...
										<div class="form-actions no-margin-bottom" style="text-align:center;">
                                            <input type="submit" name="deleteCategory" value="delete Category" class="btn btn-primary btn-lg " />
                                        </div>
										</form>
		</div>
        </div>
