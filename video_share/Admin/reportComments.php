        ...
        <div id='wrap' style='margin-top:65px;'>
           ...
           <div id='left' >
                <div class='media user-media well-small'>
                    ...
                    <li class="active"><a href='reportComments.php'><i class='icon-columns'></i> all reported comment </a></li>
                    ...
                    <div class='panel panel-default'>
                        ...
                        <div class='panel-body'>
                            <div class='table-responsive'>
                                <form action="reportComments.php"  method="post" >
...
$result = $admin->showCommentsReports();
