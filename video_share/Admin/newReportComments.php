...
if (isset($_POST['deleteComment'])) {
    ...
    if ($admin->deleteComment($commentId)) {
        $title = "successfully";
...
{
	notify("warning", "select comment to delete first");
}
}
?>
        <!-- MAIN WRAPPER -->
                    ...
                    <div class='panel panel-default'>
                        ...
                        <div class='panel-body'>
                            <div class='table-responsive'>
                                <form action="newReportComments.php"  method="post" >
...
$result = $admin->showNewCommentReports();

while ($row = $result->fetch_assoc()) {

    echo "
											<tr>
											<td><input type='radio' name='commentId' value='" . $row["commentId"] . "'>
											<td>" . $row["userId"] . "</td>
...
?>
                                    ...
                                    <div style="text-align:center;">
                                        <input type="submit" class="'btn btn-danger" name="deleteComment" value="delete Comment"> </div>
                            </div>
                            </form>
                        </div>
