    ...
    <div id='wrap' style='margin-top:65px;'>
     ...
     <div id='left' >
            ...
            <ul id='menu' class='collapse'>
                ...
                <li class="active"><a href='viewUsers.php'><i class='icon-table'></i>  Users </a></li>
    ...
    <!--END MENU SECTION -->
      ...
      <!--**************==================== echo here ========================= ********--->
                                        ...
                                        <tr class='gradeA'>
                                            ...
                                            <td><div><button class='btn btn-danger'>block</button></div></td>
                                        ...
                                        <tr class='gradeA'>
                                            ...
                                            <td><div><button class='btn btn-danger'>unblock</button></div></td>
