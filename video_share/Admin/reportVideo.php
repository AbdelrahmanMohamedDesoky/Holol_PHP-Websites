...
?>
        ...
        <!-- END HEADER SECTION -->
           ...
           <div id='left' >
                <div class='media user-media well-small'>
                    ...
                    <li  class="active"><a href='reportVideo.php'><i class='icon-columns'></i> all reported video </a></li>
                </ul>
                </div>
                ...
                <div class='col-lg-12'>
                    <div class='panel panel-default'>
                        ...
                        <div class='panel-body'>
							...
							<form action="reportVideos.php"  method="post" >
   ...
   */    
										 ...
										 $result= $admin->showVideosReports();
