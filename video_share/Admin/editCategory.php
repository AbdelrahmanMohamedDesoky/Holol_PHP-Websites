...
require_once 'Admin.php';
 ...
 require_once 'notification_function.php';
    ...
    if ($admin->editCategory($categoryId, $newCategoryName)) {
    $title = "successfully";
    ...
    <div id='wrap' style='margin-top:65px;'>
        ...
        <!-- END HEADER SECTION -->
             ...
             <div id='left' >
                <div class='media user-media well-small'>
                    ...
                    <li class="active"><a href='editCategory.php'><i class='icon-film'></i> edit category </a></li>
        ...
        <!--PAGE CONTENT -->
        <div id='content'>
            <div id="collapseOne" class="accordion-body collapse in body" style="margin-top:200px;">
                <form action="editCategory.php" method="post" class="form-horizontal" id="popup-validation">

                    <div class="form-group">
                        <label class="control-label col-lg-4">Select</label>
                        <div class="col-lg-7">
                            <select name="categoryId" id="cactegoryName" class="validate[required] form-control">
							<option value=''>categoryName</option>
                                <?php
                                $result = $admin->getCategories();
                                ...
                                <div class = "col-lg-7">
                                <input type = "text" class = "validate[required] form-control" placeholder = "category Name" name = "newCategoryName" id = "req">
                                </div>
                                </div>

                                <div class = "form-actions no-margin-bottom" style = "text-align:center;">
                                <input type = "submit" name="editCategory" value = "Edit Category" class = "btn btn-primary btn-lg " />
                                </div>
