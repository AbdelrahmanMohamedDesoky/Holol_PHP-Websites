			...
			<div class='top-navigation'>
				...
				<div class='drop-navigation drop-navigation'>
				  <ul class='nav nav-sidebar'>
					...
					?>
					<li class='active'><a href='#' class='menu1'><span class='glyphicon glyphicon-film' aria-hidden='true'></span>Categories<span class='glyphicon glyphicon-menu-down' aria-hidden='true'></span></a></li>
       ...
       <div class='col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main'>
			<div class='main-grids'>
				<div class='top-grids' style='min-height:600px;'>
                        ...
                        if(!empty($_GET['id'])){
                         	$categoryId= cleanSQLNumbers($_GET['id']);
							if($validator->validateLength($categoryId, 1, "Category Id")){
								if($guest->getCategoryName($categoryId) !== false){
									$categoryName = $guest->getCategoryName($categoryId);
									echo "<div class='recommended-info'><h2 style='text-align:center;color:#800000;'>$categoryName</h2></div>";
									$result = $guest->getVideosByCategory($categoryId);
									while ($videoRow = $result->fetch_assoc()) {
										...
										$videoImg = $videoRow['videoLink'];
										echo "<div class='col-md-4 resent-grid recommended-grid slider-top-grids' style='margin-top:10px;'>
		  									  <div class='resent-grid-img recommended-grid-img'>
		  									  <a href='./viewVideo.php?videoLink=$videoLink'><img src='images/$videoLink.jpg' alt='$videoLink.jpg' style='max-width:360px;max-height:260px;' /></a>
		  									  </div>
								...
								notify("Error","No Category Id Found");
							}
                        ?>
